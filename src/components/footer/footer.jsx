    ...
    return(
        <footer>
            ...
            <div className = "nameFooter">
                ...
                <p className="subtexto">Full Stack Developer & Machine Learning<br></br> Enthusiast based in Boston, specialized in creating <br></br>modern web applications and blockchain solutions.</p>
            </div>
